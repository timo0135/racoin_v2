...
class ItemController {
    ...
    public function afficherItem(Environment $twig, array $menu, string $chemin, int $annonceId, array $categories): void {
    ...
    public function supprimerItemGet(Environment $twig, array $menu, string $chemin, int $annonceId): void {
        $annonce = Annonce::find($annonceId);
        if (!$annonce) {
            echo "404";
            return;
    ...
    public function supprimerItemPost(Environment $twig, array $menu, string $chemin, int $annonceId, array $categories): void {
        $annonce = Annonce::find($annonceId);
    ...
    public function modifyGet(Environment $twig, array $menu, string $chemin, int $annonceId): void {
        $annonce = Annonce::find($annonceId);
        if (!$annonce) {
            echo "404";
            return;
    ...
    public function modifyPost(Environment $twig, array $menu, string $chemin, int $annonceId, array $categories, array $departements): void {
        $annonce = Annonce::find($annonceId);
        $annonceur = Annonceur::find($annonce->id_annonceur);
